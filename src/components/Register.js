  ...
  return (
    <div className="sign">
        ...
        <form onSubmit={handleSubmit} className="sign__form">
            ...
            <button type="submit" className="sign__form-btn" disabled={!formValid}>Зарегистрироваться</button>
        </form>
        <Link to="/sign-in" className="sign__login-link">Уже зарегистрированы? Войти</Link>
    </div>
  )
}
